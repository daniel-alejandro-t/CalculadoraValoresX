...
// JPanel donde se dibuja la gr�fica
public class Grafica extends JPanel {
	...
	public Grafica() {
		...
		addMouseWheelListener(new MouseWheelListener() {		// Funcion de hacer zoom con la rueda de raton
	...
	// m�todo para establecer la expresion de la funcion a graficar
	public void setFuncion(String funcion) throws IllegalArgumentException {
		...
		if(valido) {
			...
			updateUI();
			throw new IllegalArgumentException("Funci�n inv�lida");
		}
	}
	
	// m�todo para establecer la escala
	public void setEscala(int escala) {
		if(escala >= 5 && escala <= 100)
			this.escala = escala;
	}
	
	// m�todo que dibuja en el panel
	@Override
	...
	// m�todo que dibuja la gr�fica de una funci�n
