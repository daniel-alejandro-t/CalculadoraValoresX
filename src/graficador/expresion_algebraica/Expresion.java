...
public class Expresion {
	...
	// m?todo para establecer los elementos
	...
	// devuelve el valor num?rico de un elemento de la expresion, null si es un operador
	...
	// m?todo para convertir una expresi?n a notaci?n postfija
	public static Expresion postFija(String expresionOriginal) throws IllegalArgumentException {
		...
		if(!Expresion.valida(expresionOriginal))
			throw new IllegalArgumentException("Expresi?n inv?lida!");
	...
	// m?todo para establecer si una cadena es v?lida como expresi?n algebraica
